...
public class MetaDataIsbn10ScoreStrategy implements Isbn10ScoreStrategy {

    public static final int ISBN_LENGTH = 10;

    @NotNull @Override
    public Isbn10Score score(BookContext context) {
        ...
        if (isbn10UsingScheme == null) {
            return new Isbn10Score(null, null, MetaDataIsbn10ScoreStrategy.class);
        }
